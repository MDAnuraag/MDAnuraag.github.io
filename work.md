...
Projects where I used models to interpret indirect physical measurements.
...
Broadband optical spectra recovered trench depth, but secondary geometry parameters remained degenerate.

**Core lesson:** fit quality is not identifiability.
...
[Alloy Configuration Sampling](/work/alloy-sampling/) — composition did not determine electronic structure; configuration sampling was necessary.

[g-C₃N₄ Optical Transitions](/work/gcn-optical-transitions/) — metal doping activated visible transitions, but optical spectra did not uniquely identify dopant structure.
