...
**This will change.** I'm starting a PhD somewhere in Fall 2026. As I encounter systems this framework doesn't handle, I'll revise it.

**It's incomplete.** The Reading Ledger has 11 methods but I've only deeply used 5-6. The Notes section has 1 entry. The structure is ahead of the content because I'm building it as I go.
...
I review this site quarterly and update when:
- New projects change previous constraint analyses
- I discover I was wrong about something
- I learn new method failure modes

If it stops being updated, either:
1. The reasoning fully internalized (success), or
2. I abandoned it under career pressure (failure)
...
**Next planned review**: April 2026
...
**If you're a PI I applied to**: This site reflects my actual thinking process, not a curated portfolio. If it looks too cautious or too ambitious, that's real—not positioning.